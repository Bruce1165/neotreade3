        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            <div className="rounded-lg border border-gray-100 bg-gray-50 p-3">
              <div className="text-xs text-gray-500">{STATUS_COPY.actionable}</div>
            ...
            <div className="rounded-lg border border-gray-100 bg-gray-50 p-3">
              <div className="text-xs text-gray-500">{STATUS_COPY.observing}</div>
            ...
            <div className="rounded-lg border border-gray-100 bg-gray-50 p-3">
              <div className="text-xs text-gray-500">{STATUS_COPY.queued}</div>
              <div className="mt-1 text-xl font-semibold text-gray-900">{queuedCount}</div>
              <div className="mt-1 text-xs text-gray-500">等待执行</div>
            </div>
            <div className="rounded-lg border border-gray-100 bg-gray-50 p-3">
              <div className="text-xs text-gray-500">{STATUS_COPY.abandoned}</div>
