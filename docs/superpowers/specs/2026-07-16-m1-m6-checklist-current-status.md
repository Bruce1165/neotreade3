...
- [x] 决策可审计（至少包含输入引用与关键派生/中间状态的定位线索）
  ...
  - 证据：聚合 list 入口（按 run_id/report_id 过滤；_meta 回显 run_id/matched_count；支持 offset 分页与 cursor 游标分页并回显 next_cursor/has_more）：[main.py:L3340-L3449](file:///Users/mac/NeoTrade3/apps/api/main.py#L3340-L3449)
  - 证据：聚合 list 单测（offset 翻页 + cursor 翻页；matched_count/returned_count 区分；invalid_run_id/invalid_offset/invalid_cursor/invalid_pagination 400）：[test_m3_lifecycle_log_api_readback.py:L89-L823](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L89-L823)
  - 证据：cursor 分页设计（编码/解码、互斥规则、fail-closed 错误码）：[2026-07-17-m3-lifecycle-logs-pagination-cursor-design.md:L1-L103](file:///Users/mac/NeoTrade3/docs/superpowers/specs/2026-07-17-m3-lifecycle-logs-pagination-cursor-design.md#L1-L103)
  - 证据：cursor 版本策略（Reject v!=1）：[2026-07-17-m3-lifecycle-logs-pagination-cursor-design.md:L37-L60](file:///Users/mac/NeoTrade3/docs/superpowers/specs/2026-07-17-m3-lifecycle-logs-pagination-cursor-design.md#L37-L60)
  - 证据：cursor decode 严格类型与路径校验（v/written_at/record_id fail-closed）：[lifecycle_log_store.py:L74-L102](file:///Users/mac/NeoTrade3/neotrade3/decision_engine/lifecycle_log_store.py#L74-L102)
  - 证据：cursor decode 契约 fail-closed 单测矩阵（400 invalid_cursor）：[test_m3_lifecycle_log_api_readback.py:L689-L754](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L689-L754)
  ...
  - 证据：run_id + cursor+offset 错误码优先级（invalid_cursor 优先于 invalid_pagination）：[test_m3_lifecycle_log_api_readback.py:L757-L803](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L757-L803)
  - 证据：run_id 过滤 + offset 分页（offset=1/越界；matched_count 与 offset 回显）：[test_m3_lifecycle_log_api_readback.py:L438-L507](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L438-L507)
  - 证据：run_id 过滤 + invalid_offset（400 invalid_offset）：[test_m3_lifecycle_log_api_readback.py:L638-L674](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L638-L674)
  - 证据：run_id 过滤 + invalid_cursor（400 invalid_cursor）：[test_m3_lifecycle_log_api_readback.py:L711-L715](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L711-L715)
  - 证据：run_id 非法 + cursor/offset 混合态错误码优先级（invalid_cursor / invalid_pagination / invalid_run_id）：[test_m3_lifecycle_log_api_readback.py:L509-L551](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L509-L551)
  - 证据：run_id 空白 + cursor/offset 混合态错误码优先级（invalid_cursor / invalid_pagination / invalid_run_id）：[test_m3_lifecycle_log_api_readback.py:L560-L596](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L560-L596)
  - 证据：run_id 为空字符串 + cursor/offset 混合态错误码优先级（invalid_cursor / invalid_pagination / invalid_run_id）：[test_m3_lifecycle_log_api_readback.py:L599-L635](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L599-L635)
  - 证据：run_id 非法 + offset<0 + cursor 混合态错误码优先级（invalid_offset 优先）：[test_m3_lifecycle_log_api_readback.py:L676-L686](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L676-L686)
  - 证据：limit<=0 + run_id/cursor/offset 混合态错误码优先级（invalid_limit 优先）：[test_m3_lifecycle_log_api_readback.py:L90-L178](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L90-L178)
