...
- [x] 决策可审计（至少包含输入引用与关键派生/中间状态的定位线索）
  ...
  - 证据：聚合 list 单测（offset 翻页 + cursor 翻页；matched_count/returned_count 区分；invalid_run_id/invalid_offset/invalid_cursor/invalid_pagination 400）：[test_m3_lifecycle_log_api_readback.py:L89-L476](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L89-L476)
