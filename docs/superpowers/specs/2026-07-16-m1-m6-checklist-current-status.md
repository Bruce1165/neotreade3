...
- [x] 决策可审计（至少包含输入引用与关键派生/中间状态的定位线索）
  ...
  - 证据：cursor 分页设计（编码/解码、互斥规则、fail-closed 错误码）：[2026-07-17-m3-lifecycle-logs-pagination-cursor-design.md:L1-L99](file:///Users/mac/NeoTrade3/docs/superpowers/specs/2026-07-17-m3-lifecycle-logs-pagination-cursor-design.md#L1-L99)
