...
- [x] 决策可审计（至少包含输入引用与关键派生/中间状态的定位线索）
  ...
  - 证据：聚合 list 单测（offset 翻页 + cursor 翻页；matched_count/returned_count 区分；invalid_run_id/invalid_offset/invalid_cursor/invalid_pagination 400）：[test_m3_lifecycle_log_api_readback.py:L89-L784](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L89-L784)
  ...
  - 证据：cursor decode 契约 fail-closed 单测矩阵（400 invalid_cursor）：[test_m3_lifecycle_log_api_readback.py:L650-L716](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L650-L716)
  ...
  - 证据：run_id + cursor+offset 错误码优先级（invalid_cursor 优先于 invalid_pagination）：[test_m3_lifecycle_log_api_readback.py:L718-L758](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L718-L758)
  ...
  - 证据：run_id 过滤 + invalid_offset（400 invalid_offset）：[test_m3_lifecycle_log_api_readback.py:L599-L635](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L599-L635)
  - 证据：run_id 过滤 + invalid_cursor（400 invalid_cursor）：[test_m3_lifecycle_log_api_readback.py:L672-L688](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L672-L688)
  ...
  - 证据：run_id 非法 + offset<0 + cursor 混合态错误码优先级（invalid_offset 优先）：[test_m3_lifecycle_log_api_readback.py:L599-L647](file:///Users/mac/NeoTrade3/tests/unit/test_m3_lifecycle_log_api_readback.py#L599-L647)
