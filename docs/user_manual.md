...
- **市场阶段判断**: 自动识别牛市、熊市、震荡市、过渡期
- **板块聚焦**: 基于 RPS 指标锁定 3-5 个高人气强势板块
- **个股筛选**: 结合技术形态、基本面、资金面综合评分
- **交易信号**: 生成 A/B/C 等级交易信号，含入场/止损/止盈价
...
# 2. 启动 Dashboard（端口 18031）
python -m apps.dashboard.main --host 0.0.0.0 --port 18031 \
  --api-base-url http://127.0.0.1:18030
